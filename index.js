...
client.on("interactionCreate", async (i) => {
  ...
  if (i.customId === "basvuru_kabul") {
      ...
      kullanıcı.user.send(`Yetkili Başvurun Başarıyla **Onaylanmıştır Mülakat Girecek Permi Verildi Mülakat Bekleme Kanalına Girip Yetkili Arkadaşlarımız Sizleri Çekecektir.**`).catch(() => {});
